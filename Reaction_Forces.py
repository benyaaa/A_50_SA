...
m5 = np.mat([-(l_a-x_1),-(l_a-x_2),-(l_a-x_3),0.,0.,-sin(theta)*(l_a-(x_2-(x_a/2.))),0.,0.])
...
u6 = np.mat([(1./24.)*q*cos(theta)*x_1**4+d_1*E*I_zz])
...
u8 = np.mat([(1./24.)*q*cos(theta)*x_3**4 + P*sin(theta)*(x_3-(x_2+(x_a/2)))**3+d_3*E*I_zz])
...
>>>>>>> 31c2b5204f0bee0dfdc92d5f186ce660bd372397
